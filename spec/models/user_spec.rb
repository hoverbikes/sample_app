...
describe User do
  ...
  it "should accept valid email addresses" do
    addresses = %w[user@foo.com THE_USER@foo.bar.org japan.cakes@foo.jp]
  ...
  it "should reject invalid email addresses" do
    addresses = %w[user@foo,com THE_USER_at_foo.bar.org japan.cakes@foo.]
    addresses.each do |address|
  ...
  it "should reject email addresses identical up to case" do
    ...
    user = User.create!(@attr)
    user_with_upcased_duplicate_email = User.new(@attr.merge(:email => upcased_email))
    user_with_upcased_duplicate_email.should_not be_valid
  end
  ...
  describe "relationships" do
     ...
     # it "should destroy associated relationships when destroyed" do
     #   @user.destroy
     #     lambda do
     #       Relationship.find.all(@user)
     #     end.should raise_error(ActiveRecord::RecordNotFound)
     #   end
