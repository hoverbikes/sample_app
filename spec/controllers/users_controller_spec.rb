...
describe UsersController do
  ...
  describe "GET 'show'" do
    ...
    it "should find the proper user" do 
    get :show, :id => @user
    ...
    it "should paginate microposts" do
      35.times { Factory(:micropost, :user => @user, :content => "samply tweetin")}
      get :show, :id => @user
      response.should have_selector('div.pagination')
    end
    it "should accurately display number of microposts" do
      10.times { Factory(:micropost, :user => @user, :content => "more samply")}
      get "show", :id => @user
